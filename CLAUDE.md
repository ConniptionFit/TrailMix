...
| Field | Value |
|---|---|
| Version | **v1.1.0** — 2026-07-13. App-owned capture pipeline (silent, device-audio capable, mic-selectable) + capture FGS; see header note. Prior: v1.0.0 (commit `b723a26`) initial six-screen build. Prototype (voice-dictation era) preserved at commit `7c6f16b` — superseded, don't resurrect. |
